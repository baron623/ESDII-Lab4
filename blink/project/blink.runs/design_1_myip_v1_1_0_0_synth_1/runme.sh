...
HD_PWD='S:/ESDII-Lab4-main/blink/project/blink.runs/design_1_myip_v1_1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myip_v1_1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myip_v1_1_0_0.tcl
